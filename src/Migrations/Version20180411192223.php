 ...
 */
class Version20180411192223 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE repository_commit_compare (repository_id INTEGER NOT NULL, status VARCHAR(255) NOT NULL, ahead_by INTEGER NOT NULL, PRIMARY KEY(repository_id))');
